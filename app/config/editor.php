...
{"settings":{"toolbar_1":"styleselect,bold,italic,underline,bullist,numlist,aligncenter,alignleft,alignright,link,wp_adv","toolbar_2":"fontsizeselect,forecolor,subscript,superscript,strikethrough,nonbreaking,anchor,charmap,media,hr,image,table,wp_help","toolbar_3":"undo,redo,removeformat,copy,cut,pastetext,searchreplace,outdent,indent,visualchars,visualblocks,fullscreen,code","toolbar_4":"","toolbar_classic_block":"formatselect,bold,italic,blockquote,bullist,numlist,alignleft,aligncenter,alignright,link,forecolor,backcolor,table,wp_help","toolbar_block":"core\/image","toolbar_block_side":"tadv\/sup,tadv\/sub,core\/strikethrough,core\/code,tadv\/mark,tadv\/removeformat","panels_block":"tadv\/color-panel,tadv\/background-color-panel","options":"menubar_block,merge_toolbars,contextmenu,advlink,fontsize_formats","plugins":"anchor,visualchars,visualblocks,nonbreaking,table,searchreplace,code,link,contextmenu"},"admin_settings":{"options":"classic_paragraph_block,hybrid_mode,no_autop,table_resize_bars,table_grid,table_tab_navigation,table_advtab","disabled_editors":""}}
